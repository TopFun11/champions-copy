...
<div class="panel panel-default">
    <!-- Panel header -->
    <div class="panel-heading">
        <h3 class="panel-title"><?= __('Related Formular-operators') ?></h3>
    </div>
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($formular->formular_operators as $formularOperators): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link('', ['controller' => 'Formular-operators', 'action' => 'view', $formularOperators->id], ['title' => __('View'), 'class' => 'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['controller' => 'Formular-operators', 'action' => 'edit', $formularOperators->id], ['title' => __('Edit'), 'class' => 'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['controller' => 'Formular-operators', 'action' => 'delete', $formularOperators->id], ['confirm' => __('Are you sure you want to delete # {0}?', $formularOperators->id), 'title' => __('Delete'), 'class' => 'btn btn-default glyphicon glyphicon-trash']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
    ...
    <?php else: ?>
        <p class="panel-body">no related Formular-operators</p>
    <?php endif; ?>
</div>
<div class="panel panel-default">
    <!-- Panel header -->
    <div class="panel-heading">
        <h3 class="panel-title"><?= __('Related Formular-variables') ?></h3>
    </div>
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($formular->formular_variables as $formularVariables): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link('', ['controller' => 'Formular-variables', 'action' => 'view', $formularVariables->id], ['title' => __('View'), 'class' => 'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['controller' => 'Formular-variables', 'action' => 'edit', $formularVariables->id], ['title' => __('Edit'), 'class' => 'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['controller' => 'Formular-variables', 'action' => 'delete', $formularVariables->id], ['confirm' => __('Are you sure you want to delete # {0}?', $formularVariables->id), 'title' => __('Delete'), 'class' => 'btn btn-default glyphicon glyphicon-trash']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
    ...
    <?php else: ?>
        <p class="panel-body">no related Formular-variables</p>
    <?php endif; ?>
</div>
